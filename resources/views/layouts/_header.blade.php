<div class="layui-header">
    <div><a class="layui-logo" href="\">沟通科技CRM</a></div>
    ...
    <ul class="layui-nav layui-layout-left">
      ...
      <li class="layui-nav-item {{ active_class(if_route('customers.show'),'layui-this') }}"><a href="{{ route('customers.index') }}">所有客户</a></li>
      @else
      <li class="layui-nav-item {{ active_class(if_route('customer.index'),'layui-this') }}"><a href="{{ route('customer.index') }}">我的客户</a></li>
      @endif
      @can('manager')
