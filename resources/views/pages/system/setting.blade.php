        ...
        <table lay-filter="users-table" id="users-table">
            <thead>
                <tr>
                    ...
                    <th lay-data="{field:'permissions', minWidth: 180,
                    templet: function(d){
                        var p = '';
                        var permission = JSON.parse(d.permissions)
                        if(permission.length > 0){
                            p += permission[0].cn_name;
                        }
                        return p; 
                    }}">权限</th>
                </tr>
...
<form class="layui-form" method="POST" id="user-form" action="{{ route('user.update') }}" lay-filter="user-form" style="display:none;margin-right: 80px;">
    ...
    <div class="layui-form-item" pane="">
        ...
        <div class="layui-input-block">
                <input type="radio" name="permissions" value="1" title="设为管理员">
                <input type="radio" name="permissions" value="0" title="取消管理员">
        </div>
    </div>
    <div class="layui-form-item" pane="">
