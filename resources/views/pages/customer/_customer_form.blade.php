<form class="layui-form customer-form" id="customer-form" lay-filter="customer-form" method="POST" action="{{ route('customers.update') }}" style="display:none;margin: 10px 40px 10px 20px;">
      ...
      <div class="layui-col-xs7">
          <div class="layui-form-item">
            <div class="layui-input-block">
              <input type="text" name="contact" autocomplete="off" lay-verify="title" autocomplete="off" value="{{ old('contact') }}" placeholder="关键联系人" class="layui-input">
            </div>
          </div>
        
          <div class="layui-form-item">
            <div class="layui-input-block">
              <input type="text" name="phone" autocomplete="off" autocomplete="off" value="{{ old('phone') }}" placeholder="电话" class="layui-input">
            </div>
          </div>
        
          <div class="layui-form-item">
            <div class="layui-input-inline short-input">
              <input type="text" name="product" lay-verify="title" autocomplete="off" value="{{ old('product') }}" placeholder="成交产品" class="layui-input">
            </div>
            <div class="layui-input-inline short-input no-right">
              <input type="text" name="contract_money" lay-verify="number" autocomplete="off" value="{{ old('contract_money') }}" placeholder="合同金额" class="layui-input">
            </div>
          </div>
  ...
  <div class="layui-form-item">
    <div class="layui-input-block">
        <textarea placeholder="项目备注信息" name="comment"  class="layui-textarea">{{ old('comment') }}</textarea>
    </div>
  </div>
  <div class="layui-form-item">
      <div class="layui-input-block">
        <button class="layui-btn layui-btn-normal layui-btn-fluid" lay-submit="" lay-filter="more-info">确认修改订单资料</button>
      </div>
    </div>
